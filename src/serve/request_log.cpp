...
Json materialization_budget_json(const ninfer::MaterializationBudgetDecision& budget) {
    return Json{{"reason", ninfer::materialization_stop_reason_name(budget.reason)},
                {"search_granted_ns", budget.search_granted_ns},
                {"search_elapsed_ns", budget.search_elapsed_ns},
                {"search_performed", budget.search_performed},
...
Json materialization_json(const ninfer::MaterializationDiagnostics& diagnostics) {
    Json result{
        ...
        {"budget_decision", materialization_budget_json(diagnostics.budget_decision)},
    };
